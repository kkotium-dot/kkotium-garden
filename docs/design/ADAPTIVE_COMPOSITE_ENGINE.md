...
| 용량 (ml) | 15ml (/30ml) |
| 향 (scents) | Cotton Around · Black Cherry · April Fresh · Lemon Eucalyptus |
| 소재 / 마감 | 본체 + 명화 라벨 |
...
- 2026-06-12 (v8.3) — 상품현실시트 명화 4향 실명 추가(Cotton Around · Black Cherry · April Fresh · Lemon Eucalyptus). fidelity.scents 4향 DB seed 반영(앱 LIVE). 적재 taxonomy v2·AssetRegistry·mount_check는 §15-4 참조.
