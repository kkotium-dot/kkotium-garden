...
|---|---|---|---|---|---|
| A1 | 처분 권고 엔진(#273) | `DONE` | — | 🌸 | `4ee8585` |
| A2 | 배지 레일(#274~#276) | `DONE` | — | 🌸 | `7ebaae3` |
| B1·B2 | 판매중지 push + 원클릭 실행(#277) | `DONE` | — | 🌸 | `c36d380` |
| B3 | 처분 결정 대기함(#278) | `DONE` | A1·B1 | 🌸 | `9c3e1dd` |
| C3 | dev 환경 근본 수정(#279) | `DONE` | — | 🌸 | `9c3e1dd` |
| F1 | PRINCIPLES 분할(#31) | `DONE` | — | 🌸 | 1713→913, 무손실 PASS |
| C2 | 배지 레일 모바일 확장(#280) | `DONE` | A2 | 🌸 | `ab3702e` · 정보 비대칭 해소 |
| C1 | R-1/R-2/R-3 육안 | `DONE` | C3 | 🌸 | R-1·R-2 통과, R-3은 #281로 수정 |
| R3 | 패널 컴팩트 모드(#281) | `DONE` | C1 | 🌸 | `b2a3a80` · 장기 미해결 종결 |
| **D1** | 페르소나 1~10 + 14~15 | `IN-PROGRESS` | — | 💻 Code | **11~13 제외**(G1 종속) |
| **C4** | 재활성화 목록에 처분 권고 노출 | `READY` | A1 | 🌸 | 현재 상품명 배지만. 좀비·처분 권고 없음 |
| **G1** | 꽃단장 UI 개편 + 페르소나 동시 적용 | `WAIT-OP` | 운영자 지시 | 🌸/💻 | D1의 11~13(27문구) 흡수 |
...
**병행 가능 조합**(파일 겹침 0):
- `C4`(products/reactivation/page.tsx) ↔ `D1`(*.strings.ko.json, 💻 Code) — **완전 독립**
- `G1` 착수 시 D1의 11~13을 흡수하므로, 지시가 나오면 D1 잔여와 합류시킬 것
