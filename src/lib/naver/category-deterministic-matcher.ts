...
export function matchDeterministicCategories(
  ...
  console.log('[CATDBG6]', name, 'nouns=', JSON.stringify(nouns), 'headNoun=', headNoun, 'modifierNouns=', JSON.stringify(modifierNouns), 'excludeHas액세서리=', HEAD_NOUN_EXCLUDE.has('액세서리'));
